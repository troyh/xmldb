...
int main(int argc, char *argv[]) {
        ...
        AutoDelete<XQQuery> query(xqilla.parse(X("//MedlineCitationSet/MedlineCitation")));

        // Create a context object
        AutoDelete<DynamicContext> context(query->createDynamicContext());

        // Parse a document, and set it as the context item
        Sequence seq = context->resolveDocument(X(argv[1]), 0);
...
// int main(int argc,char* argv[])
// {
// 	std::string filepath("/home/troy/medline/medsamp2008a.xml");
// 	
// 	try
// 	{
